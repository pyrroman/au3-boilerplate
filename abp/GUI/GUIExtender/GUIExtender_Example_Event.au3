...
_GUIExtender_Section_Action($hGUI_1, 4, "Close 4", "Open 4", 225, 195, 60, 20, 1, 1) ; Push button
_GUIExtender_Section_End($hGUI_1)
...
_GUIExtender_Section_Action($hGUI_1, 0, "Close All", "Open All", 20, 340, 60, 20, 0, 1) ; Normal button
_GUIExtender_Section_End($hGUI_1)
...
_GUIExtender_Section_Action($hGUI_2, 2, "", "", 70, 20, 15, 15, 0, 1)
...
_GUIExtender_Section_Action($hGUI_2, 4, "Close 4", "Open 4", 220, 90, 60, 20, 1, 1) ; Push button
_GUIExtender_Section_End($hGUI_2)
...
_GUIExtender_Section_Action($hGUI_2, 0, "Close All", "Open All", 420, 160, 60, 20, 0, 1) ; Normal button
_GUIExtender_Section_End($hGUI_2)
