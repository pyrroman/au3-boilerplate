 ...
 * 
 * Graphin interface, AGG v.2.4 (http://www.antigrain.com) based graphics primitives
 * 
 ...
 *  See: sciter_graphin.h
 *
 **/

EXTERN_C PGraphin       SCAPI GraphinAPI();
...
EXTERN_C GRAPHIN_RESULT SCAPI GraphinRenderElement(HIMG himg, POINT where, HELEMENT what, UINT how);
...
namespace sciter
{
  ...
  inline Graphin* gapi()
  {
    static Graphin* _gapi = GraphinAPI();
    return _gapi;
  }
