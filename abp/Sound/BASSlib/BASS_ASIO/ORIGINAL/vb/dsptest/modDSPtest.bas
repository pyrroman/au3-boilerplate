...
'//////////////////////////////////////////////////////////////////////////
' modDSPtest.bas - Copyright (c) 2003-2005 JOBnik! [Arthur Aminov, ISRAEL]
...
'ASIO function
Function AsioProc_(ByVal isinput As Long, ByVal channel As Long, ByVal buffer As Long, ByVal length As Long, ByVal user As Long) As Long
    Dim c As Long

    c = BASS_ChannelGetData(chan, ByVal buffer, length)
    If (c = -1) Then c = 0
    AsioProc_ = c
End Function
