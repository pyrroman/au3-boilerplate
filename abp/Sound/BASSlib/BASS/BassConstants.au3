...
Global Const $BASS_INFO = 'dword flags;' & _ ; device capabilities (DSCAPS_xxx flags)
...
; ===============================================================================================================================
Global Const $BASS_RECORDINFO = "dword flags;" & _ ; device capabilities (DSCCAPS_xxx flags)
...
; ===============================================================================================================================
Global Const $BASS_SAMPLE = 'dword freq;' & _	; default playback rate
...
; ===============================================================================================================================
Global Const $BASS_CHANNELINFO = 'dword freq;' & _ ; default playback rate
...
Global Const $BASS_PLUGINFORM = 'dword;ptr;ptr;'

Global Const $BASS_PLUGININFO = 'dword version;' & _			; version (same form as $BASS_GetVersion)
...
; ===============================================================================================================================
 Global Const $BASS_3DVECTOR = 'float X;' & _ 		; + = right, - = left
		'float Y;' & _ 		; + = up, - = down
...
Global Const $BASS_DX8_CHORUS = 'float;' & _ 	;fWetDryMix
		'float;' & _				;fDepth
		'float;' & _				;fFeedback
		'float;' & _				;fFrequency
...
Global Const $BASS_DX8_COMPRESSOR = 'float;' & _	;fGain
		'float;' & _				;fAttack
		'float;' & _				;fRelease
		'float;' & _				;fThreshold
		'float;' & _				;fRatio
...
Global Const $BASS_DX8_DISTORTION = 'float;' & _	;fGain
		'float;' & _				;fEdge
		'float;' & _				;fPostEQCenterFrequency
		'float;' & _				;fPostEQBandwidth
		'float;'					;fPreLowpassCutoff

Global Const $BASS_DX8_ECHO = 'float;' & _ 		;fWetDryMix
		'float;' & _ 				;fFeedback
		'float;' & _ 				;fLeftDelay
		'float;' & _ 				;fRightDelay
		'int;' 						;lPanDelay

Global Const $BASS_DX8_FLANGER = 'float;' & _ 	;fWetDryMix
		'float;' & _ 				;fDepth
		'float;' & _ 				;fFeedback
		'float;' & _ 				;fFrequency
		'dword;' & _  				;lWaveform, 0=triangle, 1=sine
...
Global Const $BASS_DX8_GARGLE = 'dword;' & _ 	;dwRateHz
		'dword;' 					;dwWaveShape, 0=triangle, 1=square

Global Const $BASS_DX8_I3DL2REVERB = 'int;' & _ 	;lRoom                  [-10000, 0]      default: -1000 mB
...
Global Const $BASS_DX8_PARAMEQ = 'float;' & _ 	;fCenter
		'float;' & _ 				;fBandwidth
		'float;' 					;fGain

Global Const $BASS_DX8_REVERB = 'float;' & _ 	;fInGain                [-96.0,0.0]            default: 0.0 dB
