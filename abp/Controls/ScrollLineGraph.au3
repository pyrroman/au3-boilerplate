...
Func _SLG_CreateGraph($hGUI, $iLeft, $iTop, $iWidth, $iHeight, $iY_Min, $iY_Max, $iIncrements, $Line_Color = 0xFF00FF00, $iLine_Width = 2, $iBackGround = 0xFF000000, $bGridlines = True)
	...
	If $iBackGround = -1 Or $iBackGround = Default Then $iBackGround = 0xFF000000
	...
	_SLG_SetBackGroundColor($aGraphs[0][0], BitOR($iBackGround, 0xFF000000))
	$aGraphs[$aGraphs[0][0]][$g_bGridlines] = $bGridlines
	$aGraphs[$aGraphs[0][0]][$g_iX_counter] = 20;$iX_c
	$aGraphs[$aGraphs[0][0]][$g_iX_counter_mem] = 20;$iX_c
	$aGraphs[$aGraphs[0][0]][$g_iY_counter] = 20;$iY_c
...
; ===============================================================================================================================
Func _SLG_SetBackGroundColor($iIndex, $iARGB = 0xFF000000)
